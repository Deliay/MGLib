    ...
    public class OsbElementList : IEnumerable<Element>
    {
        ...
        private Element ReadElement()
        {
            ...
            var result = new Element
            {
                ...
                Layer = EnumParseT<Layer>(ReadParamLiteralString()),
                Origin = EnumParseT<Position>(ReadParamLiteralString()),
            ...
            if (result.ElementType == 1)
            {
                ...
                if (!IsLf())
                {
                    ...
                    if (!IsLf())
                    {
                        ...
                        if (!IsLf())
                        {
                            result.LoopType = EnumParseT<AnimationLoop>(ReadParamLiteralString());
                        }
                    }
                }
            }
